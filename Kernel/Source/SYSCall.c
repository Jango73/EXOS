...
U32 SysCall_DeleteObject (U32 Parameter)
{
  ...
  switch (Object->ID)
  {
    case ID_FILE    : CloseFile((LPFILE) Object); break;
    case ID_DESKTOP : DeleteDesktop((LPDESKTOP) Object); break;
    case ID_WINDOW  : DeleteWindow((LPWINDOW) Object); break;
  }
...
U32 SysCall_CreateSemaphore (U32 Parameter)
{
  return 0;
}
...
U32 SysCall_DeleteSemaphore (U32 Parameter)
{
  return 0;
}
...
{
  return (U32) HeapAlloc(Parameter);
}
...
{
  return (U32) GetSystemPen(Parameter);
}
