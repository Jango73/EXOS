...
BOOL MakePassword (LPCSTR lpszPassword, LPSTR lpszCrypted)
{
  ...
  for (c = 0; c < PassLength; c++)
  {
    ...
    switch (CurrentBit)
    {
      case 0 : szEncrypt[c] = (szPass[c] ^ 0x55); break;
      case 1 : szEncrypt[c] = (szPass[c] ^ 0xAA); break;
    }
  }
...
BOOL CheckPassword (LPCSTR lpszCrypted, LPCSTR lpszPassword)
{
  ...
  for (c = 0; c < PassLength; c++)
  {
    ...
    switch (CurrentBit)
    {
      case 0 : szDecrypt[c] = (szEncrypt[c] ^ 0x55); break;
      case 1 : szDecrypt[c] = (szEncrypt[c] ^ 0xAA); break;
    }
  }
