...
Goal: enable n-core SMP on modern x86 (i386 and x86-64) using Local APIC + IOAPIC, with minimal regression for current single-core flow. PIT compatibility is optional; prefer LAPIC timers.
