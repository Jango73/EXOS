...
# Generated by scripts/linux/net/setup-local-netboot.sh
interface=$IFACE
bind-interfaces
...
echo "[setup-local-netboot] Next: deploy artifacts with scripts/linux/net/deploy-local-netboot.sh --arch $ARCH --slot latest --rotate"
