...
int GetDriveInfo (U32 Drive, pDeviceControlBlock Control)
{
  ...
  switch (Regs.h.ah)
  {
    ...
    case 0x02 :
    {
      ...
      {
        case 0 : Control->Device.BytesPerSector = 128;
        case 1 : Control->Device.BytesPerSector = 256;
        case 2 : Control->Device.BytesPerSector = 512;
        case 3 : Control->Device.BytesPerSector = 1024;
      }
    }
    break;
    case 0x03 :
