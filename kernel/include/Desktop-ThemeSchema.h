...
#define DESKTOP_THEME_FAMILY_MASK_DESKTOP_ROOT (((U64)1) << 0)
#define DESKTOP_THEME_FAMILY_MASK_WINDOW_FRAME (((U64)1) << 1)
#define DESKTOP_THEME_FAMILY_MASK_WINDOW_CLIENT (((U64)1) << 2)
#define DESKTOP_THEME_FAMILY_MASK_WINDOW_TITLEBAR (((U64)1) << 3)
#define DESKTOP_THEME_FAMILY_MASK_WINDOW_TITLE_TEXT (((U64)1) << 4)
#define DESKTOP_THEME_FAMILY_MASK_WINDOW_BUTTON (((U64)1) << 5)
#define DESKTOP_THEME_FAMILY_MASK_WINDOW_RESIZE (((U64)1) << 6)
#define DESKTOP_THEME_FAMILY_MASK_CONTROL_BUTTON (((U64)1) << 7)
#define DESKTOP_THEME_FAMILY_MASK_TEXTBOX (((U64)1) << 8)
#define DESKTOP_THEME_FAMILY_MASK_MENU (((U64)1) << 9)
#define DESKTOP_THEME_FAMILY_MASK_MENU_ITEM (((U64)1) << 10)
