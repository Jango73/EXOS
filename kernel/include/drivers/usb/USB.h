...
#define USB_DESCRIPTOR_TYPE_SUPERSPEED_ENDPOINT_COMPANION 0x30
...
typedef struct tag_USB_SUPERSPEED_ENDPOINT_COMPANION_DESCRIPTOR {
    U8 Length;
    U8 DescriptorType;
    U8 MaxBurst;
    U8 Attributes;
    U16 BytesPerInterval;
} USB_SUPERSPEED_ENDPOINT_COMPANION_DESCRIPTOR, *LPUSB_SUPERSPEED_ENDPOINT_COMPANION_DESCRIPTOR;
