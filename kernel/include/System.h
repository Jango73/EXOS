...
extern UINT GetTaskRegister(void);
extern UINT GetPageDirectory(void);
extern void InvalidatePage(LINEAR Address);
extern void FlushTLB(void);
extern void TaskRunner(void);
extern void *__task_runner_start;
extern void *__task_runner_end;
extern void ClearTaskState(void);
