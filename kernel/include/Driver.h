...
#define USB_MASS_STORAGE_BULK_TIMEOUT_MS 200
#define USB_MASS_STORAGE_SCAN_RETRY_DELAY_POLLS 20

#define USB_MOUSE_DISCOVERY_RETRY_DELAY_POLLS 50
#define USB_MOUSE_SUBMIT_RETRY_DELAY_POLLS 10

#define USB_KEYBOARD_DISCOVERY_RETRY_DELAY_POLLS 50
