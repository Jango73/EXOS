...
static void ScanCodeToKeyCode (U32 ScanCode, LPKEYCODE KeyCode)
{
  ...
  if (ScanCode >= SCAN_PAD_7 && ScanCode <= SCAN_PAD_DOT)
  {
    if (Keyboard.NumLock)
    {
      switch (ScanCode)
      {
        case SCAN_PAD_7   : KeyCode->VirtualKey = VK_7;   KeyCode->ASCIICode = '7'; break;
        case SCAN_PAD_8   : KeyCode->VirtualKey = VK_8;   KeyCode->ASCIICode = '8'; break;
        case SCAN_PAD_9   : KeyCode->VirtualKey = VK_9;   KeyCode->ASCIICode = '9'; break;
        case SCAN_PAD_4   : KeyCode->VirtualKey = VK_4;   KeyCode->ASCIICode = '4'; break;
        case SCAN_PAD_5   : KeyCode->VirtualKey = VK_5;   KeyCode->ASCIICode = '5'; break;
        case SCAN_PAD_6   : KeyCode->VirtualKey = VK_6;   KeyCode->ASCIICode = '6'; break;
        case SCAN_PAD_1   : KeyCode->VirtualKey = VK_1;   KeyCode->ASCIICode = '1'; break;
        case SCAN_PAD_2   : KeyCode->VirtualKey = VK_2;   KeyCode->ASCIICode = '2'; break;
        case SCAN_PAD_3   : KeyCode->VirtualKey = VK_3;   KeyCode->ASCIICode = '3'; break;
        case SCAN_PAD_0   : KeyCode->VirtualKey = VK_0;   KeyCode->ASCIICode = '0'; break;
        case SCAN_PAD_DOT : KeyCode->VirtualKey = VK_DOT; KeyCode->ASCIICode = '.'; break;
      }
    }
    else
    {
      switch (ScanCode)
      {
        case SCAN_PAD_7   : KeyCode->VirtualKey = 0;           break;
        case SCAN_PAD_8   : KeyCode->VirtualKey = VK_UP;       break;
        case SCAN_PAD_9   : KeyCode->VirtualKey = VK_PAGEUP;   break;
        case SCAN_PAD_4   : KeyCode->VirtualKey = VK_LEFT;     break;
        case SCAN_PAD_5   : KeyCode->VirtualKey = 0;           break;
        case SCAN_PAD_6   : KeyCode->VirtualKey = VK_RIGHT;    break;
        case SCAN_PAD_1   : KeyCode->VirtualKey = VK_END;      break;
        case SCAN_PAD_2   : KeyCode->VirtualKey = VK_DOWN;     break;
        case SCAN_PAD_3   : KeyCode->VirtualKey = VK_PAGEDOWN; break;
        case SCAN_PAD_0   : KeyCode->VirtualKey = VK_INSERT;   break;
        case SCAN_PAD_DOT : KeyCode->VirtualKey = VK_DELETE;   break;
      }
    }
  }
  else
  if
  (
    Keyboard.Status[SCAN_LEFT_SHIFT] ||
    Keyboard.Status[SCAN_RIGHT_SHIFT] ||
    Keyboard.CapsLock
  )
  {
  ...
  if
  (
    Keyboard.Status[SCAN_ALT] ||
    Keyboard.Status[SCAN_RIGHT_ALT]
  )
  {
...
static void ScanCodeToKeyCode_E0 (U32 ScanCode, LPKEYCODE KeyCode)
{
  ...
  switch (ScanCode)
  {
    case SCAN_RIGHT_CONTROL : KeyCode->VirtualKey = VK_RCTRL;    break;
    case SCAN_RIGHT_ALT     : KeyCode->VirtualKey = VK_RALT;     break;
    case SCAN_HOME          : KeyCode->VirtualKey = VK_HOME;     break;
    case SCAN_UP            : KeyCode->VirtualKey = VK_UP;       break;
    case SCAN_PAGEUP        : KeyCode->VirtualKey = VK_PAGEUP;   break;
    case SCAN_LEFT          : KeyCode->VirtualKey = VK_LEFT;     break;
    case SCAN_RIGHT         : KeyCode->VirtualKey = VK_RIGHT;    break;
    case SCAN_END           : KeyCode->VirtualKey = VK_END;      break;
    case SCAN_DOWN          : KeyCode->VirtualKey = VK_DOWN;     break;
    case SCAN_PAGEDOWN      : KeyCode->VirtualKey = VK_PAGEDOWN; break;
    case SCAN_INSERT        : KeyCode->VirtualKey = VK_INSERT;   break;
    case SCAN_DELETE        : KeyCode->VirtualKey = VK_DELETE;   break;
    case SCAN_PAD_ENTER :
    {
...
U32 StdKeyboardCommands (U32 Function, U32 Parameter)
{
  switch (Function)
  {
    case DF_LOAD         : return KeyboardInitialize();
    case DF_GETVERSION   : return MAKE_VERSION(VER_MAJOR, VER_MINOR);
    case DF_GETLASTFUNC  : return 0;
    case DF_KEY_GETSTATE : return 0;
    case DF_KEY_ISKEY    : return (U32) PeekChar();
    case DF_KEY_GETKEY   : return (U32) GetKeyCode((LPKEYCODE) Parameter);
    case DF_KEY_GETLED   : return (U32) GetKeyboardLEDs();
    case DF_KEY_SETLED   : return (U32) SetKeyboardLEDs(Parameter);
    case DF_KEY_GETDELAY : return 0;
    case DF_KEY_SETDELAY : return 0;
    case DF_KEY_GETRATE  : return 0;
    case DF_KEY_SETRATE  : return 0;
  }
