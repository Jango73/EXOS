...
static U32 SetVideoMode (LPGRAPHICSMODEINFO Info)
{
  ...
  for (Index = 0; ; Index++)
  {
    ...
    if
    (
      VESAModeSpecs[Index].Width == Info->Width &&
  ...
  {
    case     256 : VESAContext.GranularShift =  8; break;
    case     512 : VESAContext.GranularShift =  9; break;
    case    1024 : VESAContext.GranularShift = 10; break;
    case    2048 : VESAContext.GranularShift = 11; break;
    case    4096 : VESAContext.GranularShift = 12; break;
    case    8192 : VESAContext.GranularShift = 13; break;
    case   16384 : VESAContext.GranularShift = 14; break;
    case   32768 : VESAContext.GranularShift = 15; break;
    case   65536 : VESAContext.GranularShift = 16; break;
    case  131072 : VESAContext.GranularShift = 17; break;
    case  262144 : VESAContext.GranularShift = 18; break;
    case  524288 : VESAContext.GranularShift = 19; break;
    case 1048576 : VESAContext.GranularShift = 20; break;
    case 2097152 : VESAContext.GranularShift = 21; break;
    case 4194304 : VESAContext.GranularShift = 22; break;
    default      : VESAContext.GranularShift = 16; break;
  }
...
static COLOR SetPixel8 (LPVESACONTEXT Context, I32 X, I32 Y, COLOR Color)
{
  ...
  if
  (
    X < Context->Header.LoClip.X ||
    X > Context->Header.HiClip.X ||
    Y < Context->Header.LoClip.Y ||
...
static COLOR SetPixel24 (LPVESACONTEXT Context, I32 X, I32 Y, COLOR Color)
{
  ...
  TOfs1 = Offset + 0; Bank1 = TOfs1 >> Context->GranularShift;
  TOfs2 = Offset + 1; Bank2 = TOfs2 >> Context->GranularShift;
  TOfs3 = Offset + 2; Bank3 = TOfs3 >> Context->GranularShift;
...
static U32 Rect8
(LPVESACONTEXT Context, I32 X1, I32 Y1, I32 X2, I32 Y2)
{
/*
  long  offset;
  long  bank;
...
)
{
  ...
  if (Context->Header.Brush != NULL && Context->Header.Brush->ID == ID_BRUSH)
  {
    ...
    Ofs1 = Offset + 0; Bank1 = Ofs1 >> Context->GranularShift;
    Ofs2 = Offset + 1; Bank2 = Ofs2 >> Context->GranularShift;
    Ofs3 = Offset + 2; Bank3 = Ofs3 >> Context->GranularShift;
    ...
    for (Y = Y1; Y <= Y2; Y++)
    {
      for (X = X1; X <= X2; X++)
      {
        switch (Context->Header.RasterOperation)
        {
          case ROP_SET :
          {
            SWITCHBANK(Context, Bank1); *(Pln1) = R;
            SWITCHBANK(Context, Bank2); *(Pln2) = G;
            SWITCHBANK(Context, Bank3); *(Pln3) = B;
          }
          break;
...
U32 VESACommands (U32 Function, U32 Param)
{
  switch (Function)
  {
    case DF_LOAD            : return (U32) VESAInitialize();
    case DF_UNLOAD          : return (U32) VESAUninitialize();
    case DF_GETVERSION      : return MAKE_VERSION(VER_MAJOR, VER_MINOR);
    case DF_GFX_SETMODE     : return SetVideoMode((LPGRAPHICSMODEINFO) Param);
    case DF_GFX_CREATEBRUSH : return (U32) VESA_CreateBrush((LPBRUSHINFO) Param);
    case DF_GFX_CREATEPEN   : return (U32) VESA_CreatePen((LPPENINFO) Param);
    case DF_GFX_SETPIXEL    : return VESA_SetPixel((LPPIXELINFO) Param);
    case DF_GFX_GETPIXEL    : return VESA_GetPixel((LPPIXELINFO) Param);
    case DF_GFX_LINE        : return VESA_Line((LPLINEINFO) Param);
    case DF_GFX_RECTANGLE   : return VESA_Rectangle((LPRECTINFO) Param);
  }
