...
{
	KernelLogText(LogType, TEXT("PAGEDIRECTORY:\n"
		"  Present       = %u\n"
		"  ReadWrite     = %u\n"
		"  Privilege     = %u\n"
		"  WriteThrough  = %u\n"
...
{
	KernelLogText(LogType, TEXT("PAGETABLE:\n"
		"  Present       = %u\n"
		"  ReadWrite     = %u\n"
		"  Privilege     = %u\n"
		"  WriteThrough  = %u\n"
...
{
	KernelLogText(LogType, TEXT("SEGMENTDESCRIPTOR:\n"
		"  Limit_00_15   = 0x%04X\n"
		"  Base_00_15    = 0x%04X\n"
		"  Base_16_23    = 0x%02X\n"
		"  Accessed      = %u\n"
		...
		"  Granularity   = %u\n"
		"  Base_24_31    = 0x%02X\n"),
		(U16)SegmentDescriptor->Limit_00_15,
		(U16)SegmentDescriptor->Base_00_15,
