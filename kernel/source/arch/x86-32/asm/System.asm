...
BITS 32
    ...
    global MemoryCopy
    global MemoryMove
    global GraphicsDrawScanlineAsm
    global GraphicsDrawHorizontalGradientScanlineAsm
    global GraphicsFillVerticalGradientRectAsm
    global MaskIRQ
    global UnmaskIRQ
    global DisableIRQ
    global EnableIRQ
...
.gradient_dispatch:
    ...
    push    dword [ebp + PBN]
    call    GraphicsDrawHorizontalGradientScanlineAsm
    add     esp, 24
    jmp     .done
...
FUNC_HEADER
GraphicsDrawHorizontalGradientScanlineAsm :
...
FUNC_HEADER
GraphicsFillVerticalGradientRectAsm :
