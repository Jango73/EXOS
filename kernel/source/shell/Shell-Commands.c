...
SHELL_COMMAND_ENTRY COMMANDS[] = {
    ...
    {"cp", "copy", "", "Copy file or folder", CMD_copy},
    ...
    {"desktop", "desktop", "start|status|theme <path-or-name>", "Control desktop and theme runtime", CMD_desktop},
    ...
    {"process", "show_process", "Number", "Show process details", CMD_showprocess},
    ...
    {"task", "show_task", "Number", "Show task details", CMD_showtask},
