...
static LPCSTR G_EmbeddedScripts[SHELL_EMBEDDED_SCRIPT_COUNT] = {
    ...
    [SHELL_EMBEDDED_SCRIPT_DRIVER_DETAILS] = (LPCSTR)
        ...
        "found = 0;\n"
        "for (i = 0; i < count; i = i + 1) {\n"
        "    if (drivers[i].alias != target_alias) {\n"
        "        continue;\n"
        "    }\n"
        "    found = 1;\n"
        "    alias = drivers[i].alias;\n"
        ...
        "    }\n"
        "    print(\"Alias              : \" + alias);\n"
        "    print(\"Type               : \" + drivers[i].type_name + \" (\" + drivers[i].type + \")\");\n"
        "    print(\"Version fields     : \" + drivers[i].version_major + \".\" + drivers[i].version_minor);\n"
        "    print(\"Designer           : \" + drivers[i].designer);\n"
        "    print(\"Manufacturer       : \" + drivers[i].manufacturer);\n"
        "    print(\"Product            : \" + product);\n"
        "    print(\"Flags              : \" + drivers[i].flags);\n"
        "    if (drivers[i].ready != 0) {\n"
        "        print(\"Ready              : yes\");\n"
        "    } else {\n"
        "        print(\"Ready              : no\");\n"
        "    }\n"
        "    print(\"Enum domains       : \" + drivers[i].enum_domain_count);\n"
        "    if (drivers[i].enum_domain_count == 0) {\n"
        "        print(\"  <none>\");\n"
        "    } else {\n"
        "        for (j = 0; j < drivers[i].enum_domain_count; j = j + 1) {\n"
        "            print(\"  \" + j + \": \" + drivers[i].enum_domains[j]);\n"
        "        }\n"
        "    }\n"
        "    mode_count = drivers[i].mode.count;\n"
        "    print(\"Mode count         : \" + mode_count);\n"
        "    if (drivers[i].type != 11) {\n"
