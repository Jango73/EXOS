...
static const LEVEL1_PROPERTY_ENTRY BuiltinLevel1Properties[] = {
    ...
    {TEXT("window.client"), TEXT("normal"), TEXT("background"), TEXT("token:color.window.frame")},
    {TEXT("window.client"), TEXT("active"), TEXT("background"), TEXT("token:color.window.frame")},
    {TEXT("window.client"), TEXT("focused"), TEXT("background"), TEXT("token:color.window.frame")},
