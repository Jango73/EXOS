...
static const LEVEL1_PROPERTY_ENTRY BuiltinLevel1Properties[] = {
    ...
    {TEXT("button.body"), TEXT("normal"), TEXT("border_thickness"), TEXT("1")},
    {TEXT("button.body"), TEXT("hover"), TEXT("border_thickness"), TEXT("1")},
    {TEXT("button.body"), TEXT("pressed"), TEXT("border_thickness"), TEXT("1")},
    {TEXT("button.body"), TEXT("disabled"), TEXT("border_thickness"), TEXT("1")},
