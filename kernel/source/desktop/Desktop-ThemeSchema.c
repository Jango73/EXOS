...
static const THEME_SCHEMA_NAME_ID_ENTRY Elements[] = {
    ...
    {TEXT("window.border"), DESKTOP_THEME_FAMILY_WINDOW_BORDER},
...
static const THEME_SCHEMA_PROPERTY_ENTRY Properties[] = {
    {TEXT("background"), DESKTOP_THEME_PROPERTY_TYPE_COLOR,
     DESKTOP_THEME_FAMILY_MASK_DESKTOP_ROOT | DESKTOP_THEME_FAMILY_MASK_WINDOW_BORDER | DESKTOP_THEME_FAMILY_MASK_WINDOW_CLIENT |
    ...
    {TEXT("border_color"), DESKTOP_THEME_PROPERTY_TYPE_COLOR,
     DESKTOP_THEME_FAMILY_MASK_WINDOW_BORDER | DESKTOP_THEME_FAMILY_MASK_WINDOW_BUTTON | DESKTOP_THEME_FAMILY_MASK_CONTROL_BUTTON |
         DESKTOP_THEME_FAMILY_MASK_TEXTBOX | DESKTOP_THEME_FAMILY_MASK_MENU | DESKTOP_THEME_FAMILY_MASK_MENU_ITEM},
    ...
    {TEXT("corner_radius"), DESKTOP_THEME_PROPERTY_TYPE_METRIC,
     DESKTOP_THEME_FAMILY_MASK_WINDOW_BORDER | DESKTOP_THEME_FAMILY_MASK_WINDOW_TITLEBAR |
         DESKTOP_THEME_FAMILY_MASK_WINDOW_BUTTON | DESKTOP_THEME_FAMILY_MASK_CONTROL_BUTTON |
         DESKTOP_THEME_FAMILY_MASK_TEXTBOX | DESKTOP_THEME_FAMILY_MASK_MENU},
    {TEXT("corner_radius_limit"), DESKTOP_THEME_PROPERTY_TYPE_METRIC,
     DESKTOP_THEME_FAMILY_MASK_WINDOW_BORDER | DESKTOP_THEME_FAMILY_MASK_WINDOW_TITLEBAR |
         DESKTOP_THEME_FAMILY_MASK_WINDOW_BUTTON | DESKTOP_THEME_FAMILY_MASK_CONTROL_BUTTON |
         DESKTOP_THEME_FAMILY_MASK_TEXTBOX | DESKTOP_THEME_FAMILY_MASK_MENU},
    {TEXT("corner_style"), DESKTOP_THEME_PROPERTY_TYPE_STRING,
     DESKTOP_THEME_FAMILY_MASK_WINDOW_BORDER | DESKTOP_THEME_FAMILY_MASK_WINDOW_TITLEBAR |
         DESKTOP_THEME_FAMILY_MASK_WINDOW_BUTTON | DESKTOP_THEME_FAMILY_MASK_CONTROL_BUTTON |
         DESKTOP_THEME_FAMILY_MASK_TEXTBOX | DESKTOP_THEME_FAMILY_MASK_MENU},
...
static U32 GetFamilyMask(U32 FamilyID) {
    switch (FamilyID) {
        ...
        case DESKTOP_THEME_FAMILY_WINDOW_BORDER:
            return DESKTOP_THEME_FAMILY_MASK_WINDOW_BORDER;
