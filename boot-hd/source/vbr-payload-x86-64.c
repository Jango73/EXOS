...
#define PML4_ADDRESS (MEMORY_BASE)
#define PDPT_LOW_ADDRESS (MEMORY_BASE + MEMORY_PAGE_SIZE)
#define PDPT_KERNEL_ADDRESS (MEMORY_BASE + (2u * MEMORY_PAGE_SIZE))
#define PAGE_DIRECTORY_LOW_ADDRESS (MEMORY_BASE + (3u * MEMORY_PAGE_SIZE))
#define PAGE_DIRECTORY_KERNEL_ADDRESS (MEMORY_BASE + (4u * MEMORY_PAGE_SIZE))
#define PAGE_TABLE_LOW_ADDRESS (MEMORY_BASE + (5u * MEMORY_PAGE_SIZE))
