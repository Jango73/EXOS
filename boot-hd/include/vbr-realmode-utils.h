...
#define LOW_SCRATCH_SIZE 0x10000u
#define LOW_SCRATCH_START LOW_BUFFER_START
#define LOW_SCRATCH_END (LOW_SCRATCH_START + LOW_SCRATCH_SIZE)

#define KERNEL_BUFFER_LOW_START LOW_SCRATCH_END
#define KERNEL_BUFFER_LOW_SIZE (LOW_BUFFER_END - KERNEL_BUFFER_LOW_START)

#define USABLE_RAM_START LOW_SCRATCH_START
#define USABLE_RAM_END LOW_SCRATCH_END
#define USABLE_RAM_SIZE LOW_SCRATCH_SIZE
