/************************************************************************\
    ...
    xHCI page for the interrupt dump payload
...
/**
 * @brief Draw xHCI PCI information page.
...
void DrawPageXhci(LPOUTPUT_CONTEXT Context, U8 PageIndex) {
    ...
    DrawPageHeader(Context, TEXT("xHCI"), PageIndex);
    ...
    WriteFormat(Context, OUTPUT_VALUE_COLUMN, TEXT("BAR0 Base"), TEXT("%p\r\n"), Controller.Bar0Base);
